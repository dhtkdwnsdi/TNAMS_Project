   ...
   <div class="row">
      ...
      <div class="col-md-12">
         ...
         <div class="box">
            ...
            <form role="form" method="post" action="dept?command=deptModify"
                  ...
                  <div class="form-group input-short">
                     ...
                     <div class="col-sm-10">
                        <input type="text" name='dept_name' class="form-control"
                           value=${dept_name}> <span
                           id="validatePwEmailMessage"></span>
                     </div>
                  </div>

                  <div class="form-group input-short">
                     <label for="exampleInputEmail1" class="col-sm-2 control-label">연락처<span
                        class="must-mark">*</span></label>
                     <div class="col-sm-10">
                        <input type="text" name='dept_phonenum' class="form-control"
                           value=${dept_phonenum}> <span
                           id="validatePwEmailMessage"></span>
                     </div>
                  </div>
