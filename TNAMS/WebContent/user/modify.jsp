...
<script text="text/javascript" src="script/attendItem.js"></script>
<!-- Main content -->
      ...
      <div class="col-md-12">
         ...
         <div class="box box-primary">
            <div class="box-header">
               <h3 class="box-title">근태항목 수정</h3>
            </div>
            <!-- /.box-header -->

            <form name="frm" role="form" method="post" class="form-horizontal"
            action="/attendItem?command=attendItemUpdate">
               <input type="hidden" name="attendItemNum" value="${aVo.attendItemNum}">
               <div class="box-body box-form-custom">
                  <div class="form-group input-short">
                     ...
                     <div class="col-sm-10">
                        <input type="text" name='attendName' class="form-control"
                           placeholder=" disabled="disabled" value="${aVo.attendName}">
                  ...
                  <div class="form-group input-short">
                     ...
                     <div class="col-sm-10">
                        ...
                        <option value="">선택</option>
                                 <c:if test="${aVo.vacation == '유'}">
                                    <option value="${aVo.vacation}"
                                       selected="selected">${aVo.vacation}</option>   
                                       <option value="무">무</option>
                                 </c:if>
                                 <c:if test="${aVo.vacation == '무'}">
                                    <option value="${aVo.vacation}"
                                       selected="selected">${aVo.vacation}</option>
                  ...
                  <div class="form-group input-short">
                     ...
                     <div class="col-sm-10">
                     <select id="vacation" name='paid' class="form-control" >
                        <option value="">선택</option>
                                 <c:if test="${aVo.paid == '유'}">
                                    <option value="${aVo.paid}"
                                       selected="selected">${aVo.paid}</option>   
                                       <option value="무">무</option>
                                 </c:if>
                                 <c:if test="${aVo.paid == '무'}">
                                    <option value="${aVo.paid}"
                                       selected="selected">${aVo.paid}</option>
                                       <option value="유">유</option>
                                 </c:if>
               ...
               <div class="box-footer btn-group-center">
                  ...
                  <button type="submit" class="btn btn-primary" id="submitbutton" onclick="return checkAttendItem">수정</button>
