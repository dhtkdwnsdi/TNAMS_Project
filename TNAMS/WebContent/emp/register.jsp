				...
				<form id='frm' role="form" onsubmit="return validateEmptyVal()"
					...
					<div class="box-body box-form-custom">
						...
						<div class="form-group input-short">
							...
							<div class="col-sm-10">
								<select class="form-control" name="deptNum">
						...
						<div class="form-group input-short">
							...
							<div class="col-sm-10">
								<input id="cellPhone" type="text" name='birthday' maxlength="13"
									class="form-control" placeholder="ex) 19950329">
							</div>
						</div>
						...
						<div class="form-group input-short">
							...
							<div class="col-sm-10">
								<input type="text" name='email' class="form-control"
									placeholder="ex) sample01@samp.le">
							</div>
						</div>
						...
						<div class="form-group input-short">
							...
							<div class="col-sm-10">
								<input id="hp" type="text" name='hp' maxlength="13"
									class="form-control" placeholder="ex) 010-4045-3402">
							</div>
						</div>
							...
							<div class="col-sm-4">
								<div class='input-group date' id='datetimepicker6'>
									<span class="input-group-addon" id="sdate-addon"> <span
										...
										class="form-control" name="workDate" placeholder="입사일을 입력하세요." />
								</div>
							</div>
							...
							<div class="col-sm-4">
								<div class='input-group date' id='datetimepicker7'>
									<span class="input-group-addon"> <span
										...
										placeholder="퇴사일을 입력하세요." readonly />
								</div>
							</div>
						</div>
						...
						<div class="form-group input-long">
							...
							<div class="row col-md-10">
								<div class="col-md-3 col-xs-4">
									<input name='zipCode' class="form-control" placeholder="우편번호"
										readonly>
								</div>
						...
						<div class="form-group input-short">
							...
							<div class="col-sm-10">
								<input name='frontAddr' class="form-control" placeholder="주소"
									readonly>
							</div>
						</div>
