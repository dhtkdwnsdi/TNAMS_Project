            ...
            <form id="frm" name="frm" role="form" onsubmit="return validateEmptyVal()"
               ...
               <div class="box-body box-form-custom">
                  ...
                  <div class="form-group input-short">
                     ...
                     <div class="col-sm-10">
                        <select class="form-control" name="deptNum" value="${eVo.deptName}">
                           <%-- <c:forEach items="${EmpList}" var="EmpVO" varStatus="status">
                              <option value="${comp.compNum}">${comp.compName}</option>
                           </c:forEach> --%>
                           <option value="" selected="${eVo.deptName}">${eVo.deptName}</option>
                  ...
                  <div class="form-group input-short">
                     ...
                     <div class="col-sm-10">
                        <select class="form-control" name="empPosition">
                           <option value="" selected="${eVo.empPosition}">${eVo.empPosition}</option>
                  ...
                  <div class="form-group input-short">
                     ...
                     <div class="col-sm-10">
                        <input id="cellPhone" type="text" name='birthday' maxlength="13"
                           class="form-control" value="${eVo.birthday}">
                     </div>
                  </div>
                  ...
                  <div class="form-group input-short">
                     ...
                     <div class="col-sm-10">
                        <input id="hp" type="text" name='hp' maxlength="13"
                           class="form-control" value="${eVo.hp}">
                     </div>
                  </div>
                  ...
                  <div class="form-group input-long">
                     ...
                     <div class="row col-md-10">
                        <div class="col-md-3 col-xs-4">
                           <input name='zipCode' class="form-control" value="${eVo.zipCode}"
                              readonly>
                        </div>
                  ...
                  <div class="form-group input-short">
                     ...
                     <div class="col-sm-10">
                        <input type="text" name='frontAddr' class="form-control" value="${eVo.frontAddr}"
                           readonly>
                     </div>
                  </div>
                  ...
                  <div class="form-group input-short">
                     <label for="exampleInputEmail1" class="col-sm-2 control-label">상세주소<span
                        class="must-mark">*</span></label>
                     <div class="col-sm-10">
                        <input type="text" name='rearAddr' class="form-control" value="${eVo.rearAddr}">
                     </div>
                  </div>
                  ...
                  <div class="form-group input-short">
                     <label for="exampleInputEmail1" class="col-sm-2 control-label">
                        최종학력 </label>
                     <div class="col-sm-10">
                        <select class="form-control" name="finalEducation" value="${eVo.finalEducation}">
