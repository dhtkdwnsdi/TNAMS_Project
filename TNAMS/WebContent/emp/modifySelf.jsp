	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<div class="box box-primary">
				...
				<form id="frm" name="frm" role="form" method="post" class="form-horizontal" action = "/emp?command=empModifySelf">
					...
					<div class="box-body box-form-custom">
						<div class="form-group input-short">
							...
							<div class="col-sm-10">
								<input type="text" name='empNum' class="form-control" value="20191004" readonly>
							</div>
						</div>
						...
						<div class="form-group input-short">
							<label for="exampleInputEmail1" class="col-sm-2 control-label">
								비밀번호 <span class="must-mark">*</span>
							</label>
							<div class="col-sm-10">
						...
						<div class="form-group input-short">
							<label for="exampleInputEmail1" class="col-sm-2 control-label">
								비밀번호 확인 <span class="must-mark">*</span>
							</label>
							<div class="col-sm-10">
								<input type="password" name='empPw2' class="form-control">
							</div>
						</div>
						...
						<div class="form-group input-short">
							...
							<div class="col-sm-10">
								<select class="form-control" name="deptNum" value="영업지원부">
						...
						<div class="form-group input-short">
							...
							<div class="col-sm-10">
								<select class="form-control" name="empPosition">
									<option value="대표이사" selected="대표이사">대표이사</option>
						...
						<div class="form-group input-short">
							...
							<div class="col-sm-10">
								<input id="birthday" type="text" name='birthday' maxlength="13"
									class="form-control" value="19950220">
							</div>
						</div>
						...
						<div class="form-group input-short">
							...
							<div class="col-sm-10">
								<input id="hp" type="text" name='hp' maxlength="13"
									class="form-control" value="01051776343">
							</div>
						</div>
						...
						<div class="form-group input-long">
							...
							<div class="row col-md-10">
								<div class="col-md-3 col-xs-4">
									<input name='zipCode' class="form-control" value="17003"
										readonly>
								</div>
						...
						<div class="form-group input-short">
							...
							<div class="col-sm-10">
								<input type="text" name='frontAddr' class="form-control" value="경기 용인시 동백7로 96(동백동, 백현마을)"
									readonly>
							</div>
						</div>
						...
						<div class="form-group input-short">
							<label for="exampleInputEmail1" class="col-sm-2 control-label">상세주소<span
								class="must-mark">*</span></label>
							<div class="col-sm-10">
								<input type="text" name='rearAddr' class="form-control" value="2315동 1804호">
							</div>
						</div>
						...
						<div class="form-group input-short">
							<label for="exampleInputEmail1" class="col-sm-2 control-label">
								최종학력 </label>
							<div class="col-sm-10">
								<select class="form-control" name="finalEducation" >
									<option value="대학교졸" selected>대학교졸</option>
						...
						<button type="submit" class="btn btn-primary" onclick="return check()">수정</button>
